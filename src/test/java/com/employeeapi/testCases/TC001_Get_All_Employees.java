...
public class TC001 extends TestBase{
	...
	logger.info("*********Started TC001_Get_Al **********");
...
//	
	...
	System.out.println("---------------");
	//String id= RestAssured.given().contentType(ContentType.JSON).log().all().get("/networks").then().extract().path("company");
	...
	void checkserverType()
	{
		...
		Assert.assertEquals(serverType, "nginx/1.15.9 (Ubuntu)");
